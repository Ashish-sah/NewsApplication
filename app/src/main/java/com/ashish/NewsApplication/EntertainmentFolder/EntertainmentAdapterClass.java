...
public class EntertainmentAdapterClass extends RecyclerView.Adapter<EntertainmentAdapterClass.MyViewHolder> {
    private Context context;

    public EntertainmentAdapterClass(Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        holder.titleView.setText(EntertainmentActivity.list.get(position).getTitle());
        holder.detailsView.setText(EntertainmentActivity.list.get(position).getDetails());
        //loading image
        Glide.with(context).load(EntertainmentActivity.list.get(position).getImageUrl()).into(holder.imgView);
            ...
            public void onClick(View v) {
             //   Toast.makeText(v.getContext(),"Layout not made", Toast.LENGTH_LONG).show();
               Intent myIntent = new Intent(v.getContext(), newsExplorer.class);
                myIntent.putExtra("newsUrl", EntertainmentActivity.list.get(position).getNewsUrl());
    ...
    public int getItemCount() {
        ...
        return EntertainmentActivity.list.size();
