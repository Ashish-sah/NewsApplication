...
public class HealthActivity extends AppCompatActivity {
    ...
    private void fetchHealthNews() {
        ...
        progressDialog.show();
        String NewsUrl = "https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=d7fb75a0748247aaaf5682632f840de9";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new HealthAdapterClass(getApplicationContext());
    ...
    public void setupUi() {
        ...
        bottomNavigationView.setSelectedItemId(R.id.healthNews);
