...
public class HealthAdapterClass extends RecyclerView.Adapter<HealthAdapterClass.MyViewHolder> {
    private Context context;

    public HealthAdapterClass(Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        holder.titleView.setText(HealthActivity.list.get(position).getTitle());
        holder.detailsView.setText(HealthActivity.list.get(position).getDetails());
        //loading image
        Glide.with(context).load(HealthActivity.list.get(position).getImageUrl()).into(holder.imgView);
     ...
     //           Toast.makeText(v.getContext(),"Layout not made", Toast.LENGTH_LONG).show();
               Intent myIntent = new Intent(v.getContext(), newsExplorer.class);
                myIntent.putExtra("newsUrl", HealthActivity.list.get(position).getNewsUrl());
    ...
    public int getItemCount() {
        ...
        return HealthActivity.list.size();
