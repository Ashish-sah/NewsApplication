...
public class ScienceAdapterClass extends RecyclerView.Adapter<ScienceAdapterClass.MyViewHolder> {
    private Context context;

    public ScienceAdapterClass(Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        holder.titleView.setText(ScienceActivity.list.get(position).getTitle());
        holder.detailsView.setText(ScienceActivity.list.get(position).getDetails());
        //loading image
        Glide.with(context).load(ScienceActivity.list.get(position).getImageUrl()).into(holder.imgView);
        ...
        holder.explore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Intent myIntent = new Intent(v.getContext(), newsExplorer.class);
                myIntent.putExtra("newsUrl", ScienceActivity.list.get(position).getNewsUrl());
    ...
    public int getItemCount() {
        ...
        return ScienceActivity.list.size();
