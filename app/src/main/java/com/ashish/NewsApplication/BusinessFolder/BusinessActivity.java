...
public class BusinessActivity extends AppCompatActivity {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new BusinessAdapterClass(getApplicationContext());
    ...
    public void setupUi() {
        ...
        bottomNavigationView.setSelectedItemId(R.id.businessNews);
    ...
    private void switchScreen(int id) {
        switch (id) {
            case R.id.aboutDev: {
                Intent intent = new Intent(getApplicationContext(), BusinessDeveloper.class);
