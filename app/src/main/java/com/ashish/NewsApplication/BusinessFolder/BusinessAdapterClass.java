...
public class BusinessAdapterClass extends RecyclerView.Adapter<BusinessAdapterClass.MyViewHolder> {
    private Context context;

    public BusinessAdapterClass(Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        holder.titleView.setText(BusinessActivity.list.get(position).getTitle());
        holder.detailsView.setText(BusinessActivity.list.get(position).getDetails());
        //loading image
        Glide.with(context).load(BusinessActivity.list.get(position).getImageUrl()).into(holder.imgView);
        ...
        holder.explore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Intent myIntent = new Intent(v.getContext(), newsExplorer.class);
                myIntent.putExtra("newsUrl", BusinessActivity.list.get(position).getNewsUrl());
    ...
    public int getItemCount() {
        ...
        return BusinessActivity.list.size();
