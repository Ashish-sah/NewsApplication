...
public class SportsActivity extends AppCompatActivity {
    ...
    private void fetchSportsNews() {
        ...
        progressDialog.show();
        String NewsUrl = "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=d7fb75a0748247aaaf5682632f840de9";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new SportsAdapterClass(getApplicationContext());
    ...
    public void setupUi() {
        ...
        bottomNavigationView.setSelectedItemId(R.id.sportsNews);
